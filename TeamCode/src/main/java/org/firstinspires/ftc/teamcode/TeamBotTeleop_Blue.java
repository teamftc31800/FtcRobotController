...
@TeleOp(name="TeamBotTeleop_Blue", group="Drive")
public class TeamBotTeleop_Blue extends OpMode {
    ...
    // Targets
    private static double FLYWHEEL_TARGET_RPM = 2550.;  // +150 for corrected F=13.8
...
//            telemetry.addLine("⚠️ Right feeder servo not found (name: 'feederServoRight').");
    ...
    public void loop() {
        ...
        if (visionPortal != null && aprilTag != null) {
            ...
            if (camState == VisionPortal.CameraState.STREAMING) {
                ...
                for (AprilTagDetection detection : currentDetections) {
                    if (detection.id == BLUE_GOAL_TAG_ID && detection.ftcPose != null) {
        ...
        //----------------------------------
        // 3. AUTO-AIM — updates RPM and arm angle whenever tag is visible
        //----------------------------------
